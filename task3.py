    ...
    while heap:
        ...
        for neighboridx in neighbors:
            ...
            if neighboridx in visited:
                ...
                if not worthRevisit(totaldist, totalenergy, visitedcosts):
                    continue
                visited[neighboridx].append([totaldist, totalenergy])
            else:
                visited[neighboridx] = [[totaldist, totalenergy]]
            ...
            newNode.g = totaldist
            # newNode.h = 0.0
            newNode.h = euclideanDist(newNode.x, newNode.y, endNode.x, endNode.y)
            newNode.updatef()
